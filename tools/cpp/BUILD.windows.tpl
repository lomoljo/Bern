...
cc_toolchain_config(
    ...
    tool_paths = {
        ...
        "deps-scanner": "%{msvc_deps_scanner_wrapper_path_x64}",
    },
...
cc_toolchain_config(
    ...
    tool_paths = {
        ...
        "deps-scanner": "%{msvc_deps_scanner_wrapper_path_x86}",
    },
...
cc_toolchain_config(
    ...
    tool_paths = {
        ...
        "deps-scanner": "%{msvc_deps_scanner_wrapper_path_arm}",
    },
...
cc_toolchain_config(
    ...
    tool_paths = {
        ...
        "deps-scanner": "%{msvc_deps_scanner_wrapper_path_arm64}",
    },
