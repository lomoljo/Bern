...
EOF
  ...
  # Create @bazel_tools//tools/cpp/cpp20modules_tools
  mkdir -p ${BAZEL_TOOLS_REPO}/tools/cpp/cpp20modules_tools
  link_file "${PWD}/tools/cpp/cpp20modules_tools/BUILD.tools" "${BAZEL_TOOLS_REPO}/tools/cpp/cpp20modules_tools/BUILD"
